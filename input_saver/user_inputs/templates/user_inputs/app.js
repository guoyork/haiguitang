...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let cluesGiven = [];
    let conversationHistory = []; // 新增：对话历史数组
    ...
    function saveState() {
        localStorage.setItem('hgtState', JSON.stringify({
            ...
            conversationHistory: conversationHistory // 新增：保存对话历史
        }));
    }
    ...
    function restoreState() {
        ...
        if (saved) {
            try {
                ...
                conversationHistory = state.conversationHistory || []; // 新增：恢复对话历史
